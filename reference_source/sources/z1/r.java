...
final class r {
    ...
    public static String a(String str) {
        ...
        for (Object[] objArr : f6682b) {
            if (objArr[0].equals(substring)) {
                return objArr[1] == f6681a ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) objArr[1]).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw g1.m.a();
        ...
        for (Object[] objArr2 : f6683c) {
            if (objArr2[0].equals(substring2)) {
                return objArr2[1] == f6681a ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) objArr2[1]).intValue(), str);
            }
        }
        for (Object[] objArr3 : f6684d) {
            if (objArr3[0].equals(substring2)) {
                return objArr3[1] == f6681a ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) objArr3[1]).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw g1.m.a();
        ...
        for (Object[] objArr4 : f6685e) {
            if (objArr4[0].equals(substring3)) {
                return objArr4[1] == f6681a ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) objArr4[1]).intValue(), str);
            }
        }
        throw g1.m.a();
    }
    ...
    private static String c(int i4, int i5, String str) {
        String substring = str.substring(0, i4);
        int min = Math.min(str.length(), i5 + i4);
        String substring2 = str.substring(i4, min);
        String str2 = "(" + substring + ')' + substring2;
        String a5 = a(str.substring(min));
        if (a5 == null) {
            return str2;
        }
        return str2 + a5;
