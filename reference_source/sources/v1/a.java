...
final class a {
    ...
    public byte[] a() {
        ...
        int h4 = this.f6276a.h();
        int l4 = this.f6276a.l();
        for (int i4 = 0; i4 < h4; i4++) {
            int[] iArr = f6275b[i4];
            for (int i5 = 0; i5 < l4; i5++) {
                int i6 = iArr[i5];
                if (i6 >= 0 && this.f6276a.e(i5, i4)) {
                    int i7 = i6 / 6;
