...
final class m {
    ...
    private final List<int[]> f6381a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List<String> f6382b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f6381a.add(iArr);
        this.f6382b.add(str);
    }
    ...
    public String c(String str) {
        ...
        for (int i5 = 0; i5 < size && parseInt >= (i4 = (iArr = this.f6381a.get(i5))[0]); i5++) {
            if (iArr.length != 1) {
                i4 = iArr[1];
            }
            if (parseInt <= i4) {
                return this.f6382b.get(i5);
            }
        }
        return null;
    }
